...
const gcTheme = {
  ...
  'keyword': TextStyle(color: Color(0xff4A8D2C), fontWeight: FontWeight.bold),
  'date': TextStyle(color: Color(0xffC2842F)),
  'selector-tag':
  ...
  'number': TextStyle(color: Color(0xff9666b9)),
  ...
  'string': TextStyle(color: Color(0xff3B6EC4)),
